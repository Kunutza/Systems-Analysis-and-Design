...
public class AdministrativeStaff extends User {
	...
	public AdministrativeStaff(String name, String password) {
		super(name, password);
		this.setAdministrativeStaffDefaultPermissions();
	}

	private void setAdministrativeStaffDefaultPermissions() {
