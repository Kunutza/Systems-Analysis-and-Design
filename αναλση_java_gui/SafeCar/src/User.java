...
public class User {
	...
	// No user can delete a user that he does not own
	protected boolean cancelApplication(Application a) {
	...
	protected ArrayList<Customer> getAllCustomersList() {
		return User.AllCustomersList;
	}
